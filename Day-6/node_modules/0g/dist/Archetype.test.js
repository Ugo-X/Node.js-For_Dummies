...
import { ComponentA as A, ComponentB as B, ComponentC as C, } from './__tests__/componentFixtures.js';
import { Entity } from './Entity.js';
import { describe, it, expect } from 'vitest';
describe('Archetypes', () => {
    const entities = [
        [[A.create(), B.create(), C.create()], 1],
        [[A.create(), B.create(), C.create()], 5],
        [[A.create(), B.create(), C.create()], 100],
    ];
